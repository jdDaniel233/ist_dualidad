...
<div class="panel-body" id="formularioregistros">
  <form action="" name="estudiante" id="estudiante" method="POST">
    ...
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <input type="text" class="form-control" name="cedula" id="cedula" placeholder="Cedula" maxlength="10">
    </div>
     <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Teléfono</label>
      <input class="form-control" type="text" name="telefono" id="telefono" maxlength="10" placeholder="Número de telefono">
    </div>
	  <div class="form-group col-lg-6 col-md-6 col-xs-12">
      ...
      <select class="form-control" type="text" name="carrera" id="carrera" maxlength="20" placeholder="Carrera">
	
      </select>
    </div>
	  <div class="form-group col-lg-6 col-md-6 col-xs-12">
      <label for="">Periodo</label>
      <select class="form-control" type="text" name="periodo" id="periodo" maxlength="20" placeholder="Periodo"> </select>
    </div>
    <div class="form-group col-lg-6 col-md-6 col-xs-12">
